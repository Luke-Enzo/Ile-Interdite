...
public class VueInstruction extends JPanel implements Observer{
	...
	/** Constructeur. */
	public VueInstruction(IModele modele) {
		this.modele = modele;
		...
		label = new JLabel("Instructions", SwingConstants.LEFT);
	...
	public void majInstrJoueurs() {
		label.setText(this.modele.instrJoueurs());
	}
